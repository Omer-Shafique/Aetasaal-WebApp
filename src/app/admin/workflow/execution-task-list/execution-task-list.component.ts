...
export class ExecutionListComponent implements OnInit {
  ...
  constructor(private toastr: ToasterService, private swalService: SwalService, private titleService: TitleService,
    ...
    private dialog: MatDialog, private configurationService: ConfigurationService, private fileUploadService: FileUploadService,
    private menuCountsService: MenuCountsService, private _activatedRoute: ActivatedRoute, private userService: UserService) { }
